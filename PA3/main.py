    ...
    for epoch in range(num_epochs):
        ...
        for batch in range(num_batches):
            ...
            if steps % train_X.shape[1] == 0 and steps != 0:
                train_loss, train_acc = CNN.performance(x,y)
                train_log.info('Epoch {}, Step {}, Loss: {}, Accuracy: {}, lr: {}'.format(epoch, steps, train_loss, train_acc, CNN.lr))
                valid_loss, valid_acc = CNN.performance(valid_X,valid_Y)
                valid_log.info('Epoch {}, Step {}, Loss: {}, Accuracy: {}, lr: {}'.format(epoch, steps, train_loss, train_acc, CNN.lr))
